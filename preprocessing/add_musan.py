...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug 13 19:48:57 2022
...
parser.add_argument('--speech_dataset', default='MELD',
                    help='speech dir')
parser.add_argument('--noise_dataset', default='music',
                    help='noise dir')
parser.add_argument('--data_set', default='train',
...
#%%        
snr_ratio_box = ['0_2', '2_4', '4_6', '6_8', '8_10', '10_12', '12_14', '14_16', '16_18', '18_20', '20_22', '22_24', '24_26', '26_28', '28_30']
...
for ses in speech_dict.keys():
    for wav in speech_dict[ses]:
        ...
        for snr_range in snr_ratio_box:
            magic_number = np.random.randint(len(noise_dict))
            n_path = noise_dict[list(noise_dict.keys())[magic_number]]
            ...
            path = Path('MELD_emo_'+args.data_set+'/wav/'+args.noise_dataset+'/'+snr_range+'/')
...
op_se_metric_df.to_csv('MELD_data_process'+'/MELD_'+args.data_set+'_meta_wav_'+args.noise_dataset+'_0_5_10.csv')
